...
$(function () {
  ...
  $('.c-js-accordionBody').hide(); // 預設讓第一個 li 加上 active

  $('.c-js-accordionItem').eq(0).addClass('c-js-accordion--active'); // 預設讓第一個 li 內文 顯示

  $('.c-js-accordionBody').eq(0).show(); // 點擊 li
  ...
  $('.c-js-accordionItem').click(function (e) {
    ...
    */
    ...
    $(this).toggleClass('c-js-accordion--active').siblings().removeClass('c-js-accordion--active'); // 讓自己的 li body 切換收合
