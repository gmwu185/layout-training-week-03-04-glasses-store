...
這樣的想法與做法也是費時的一部份，了解觀念是一回事，能透過實做落實觀念又是一回事，但能在實做的同時又能掌事細節處理能力，才算是達到活用的目的，在刻意練習一書指出要成為頂尖出色的人才，練習的時間與內容就是其中一環，就算是天才若要達到出色的境界也是透過練習，唯說時間會花費較多但必定有相對的成效。
...
https://gmwu185.github.io/layoutTraining-hexschool-flex/flexGrid.html
...
# 功能
- 判斷 nav 有沒有 .js-navbar--topFixed 樣式，若有選 .cavbar 加入浮動視窗上部，透過 jQuery 動態加入 .js-navbar--topFixedPush 補上浮動高度差。
